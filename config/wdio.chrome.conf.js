...
// process.env.DB_CHECK = true
// process.env.SKIP_OIM = true
// process.env.disableHeadless=true
...
exports.config = {
    ...
    cucumberOpts: {
       backtrace: false,   // <boolean> show full backtrace for errors
        ...
        strict: true,
        tagExpression: "@dev and @COBRA and not @wip and not @ignore",
        tagsInTitle: true
    ...
    reporters: [
        ...
        //     videoSlowdownMultiplier:6,
        //     videoRenderTimeout:100,
        //     maxTestNameCharacters:10 // Higher to get slower videos, lower for faster videos [Value 1-100]
        // }],
        "spec",
        ['mochawesome',{
            outputDir: './Results',
