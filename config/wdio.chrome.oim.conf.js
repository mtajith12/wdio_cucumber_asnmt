...
exports.config = {
    ...
    cucumberOpts: {
        ...
        strict: true,
        tagExpression: "@OIM and not @ignore",
        tagsInTitle: true,
        // retry failed scenario: https://github.com/webdriverio/webdriverio/issues/5389
    ...
    reporters: [
        ...
        "spec",
        ['mochawesome',{
            outputDir: './oim-Results',
            outputFileFormat: function(opts) {
                return `oim-results.json`
            }
        }],
        [
            "junit",
            {
                outputDir: "./oim-junit-results/",
                outputFileFormat: function (options) {
                    return `oim-results-${options.cid}.xml`;
                }
            }
        ],
        ['cucumberjs-json', {
